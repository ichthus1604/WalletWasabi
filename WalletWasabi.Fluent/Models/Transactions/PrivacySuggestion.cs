...
public record FullPrivacySuggestion(BuildTransactionResult Transaction, decimal Difference, string DifferenceText, IEnumerable<SmartCoin> Coins, bool IsChangeless) : PrivacySuggestion(Transaction);

public record BetterPrivacySuggestion(BuildTransactionResult Transaction, string DifferenceText, IEnumerable<SmartCoin> Coins, bool IsChangeless) : PrivacySuggestion(Transaction);

public record ChangeAvoidanceSuggestion(BuildTransactionResult Transaction, string DifferenceText, bool IsMore, bool IsLess) : PrivacySuggestion(Transaction)
{
